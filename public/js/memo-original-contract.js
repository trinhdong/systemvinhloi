...
function getHTMLInputContract(id) {
    ...
    _html += '    <div class="px-1 py-2 text-center" style="min-width:110px;width:100%"><input class="form-control padding-input buy_price" type="number"></div>'

    _html += '    <div class="px-1 py-2 text-center" style="min-width:90px;width:100%"><input class="form-control padding-input sales_discount_rate" type="number"></div>'
    _html += '    <div class="px-1 py-2 text-center" style="min-width:110px;width:100%"><input class="form-control padding-input price" type="number"></div>'
    ...
    _html += '    <div class="px-1 py-2 text-center" style="min-width:76px;width:100%"><input class="form-control padding-input tax" type="text"></div>'
...
function getDataMemoOriginalContractDetail() {
    ...
    $('#copy .detail_memo').each(function (index) {
        element = {
            ...
            buy_in_discount_rate: $(this).find('.buy_in_discount_rate').text(),
