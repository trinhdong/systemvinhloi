                                ...
                                <div class="p-4 rounded">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="text" name="name" class="form-control" id="area_name"
                                                   placeholder="Nhập tên khu vực" value="{{$area->name}}">
                                            <div class="invalid-feedback">Vui lòng nhập tên khu vực</div>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <label for="description" class="col-sm-2 col-form-label">Nội dung khu
                                            vực</label>
                                        <div class="col-sm-10">
                                            <textarea name="description" class="form-control" id="description"
                                                      placeholder="Nhập nội dung khu vực">{{$area->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
