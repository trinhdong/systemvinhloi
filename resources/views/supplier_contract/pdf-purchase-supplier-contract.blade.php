...
<body >
    <div class="container" >
        ...
        @else
            <div class="" style="margin-top:200px;border:1px solid white;font-size:12px"></div>
        @endif
        <div style="background-color:lightgrey;padding-top:13px;font-size:10px;">
            ...
            <div style="display:inline-block;text-align: center;width:120px;margin-left:5px;padding-top:0px;">
                ...
                <div style="display:inline-block;text-align: center;margin:0px;width:33px;margin-bottom: -5px">{{__('admin.product_hanging_rate')}}</div>
                <div style="display:inline-block;text-align: center;margin:0px;width:80px;margin-bottom: -5px">{{__('admin.product_price')}}</div>
            </div>
            <div style="display:inline-block;text-align: center;width:120px;margin-left:5px;padding-top:0px;">
            ...
            <div style="display:inline-block;width:45px;margin-left:5px">{{__('admin.product_previous_generation')}}</div>
        ...
        @foreach ($data->SupplierContractDetail as $detail)
            <div style="font-size:8px;margin-bot:0px;margin-top:2px;{{ $detail->note == null ? 'border-bottom:1px solid lightgrey;' : 'border-left: 0px;border-right: 0px;border-bottom: 1px dashed lightgray;border-style: 1px solid dashed;'}}padding: 2px 5px;background-color:rgb(255, 255, 255)">
                <div style="display:inline-block;width:200px;vertical-align: middle;margin-left:5px;padding:0px;" >
                    <div style="word-wrap: break-word;;color:rgb(105, 105, 105);font-size:9px;width:200px;">{{ $detail->product_code }}</div>
                    <div style="word-wrap: break-word;width:200px;">{{ $detail->product_name }}</div>
                    {{-- <div style="word-wrap: break-word;;color:rgb(105, 105, 105);font-size:9px;width:200px;">{{ $detail->note }}</div> --}}
                </div>
                <div style="display:inline-block;width:33px;vertical-align: middle;margin-left:5px">{{ $detail->color }}</div>
                <div style="display:inline-block;width:140px;vertical-align: middle;margin-left:5px;text-align: center;font-size:8px;">
                ...
                <div style="display:inline-block;width:33px;vertical-align: middle;margin-left:5px">{{ $detail->quantity }}</div>
                ...
                <div style="display:inline-block;width:45px;vertical-align: middle;margin-left:5px;word-wrap: break-word;">{{number_format($detail->consignment,2)}}</div>
            ...
            <div style="float: right;width:45%;padding: 10px 10px;">
                ...
                @foreach ($details as $tax => $price)
                    ...
                    @else
                        ...
                        <div style="width:99%;text-align:right;color:rgb(105, 105, 105); vertical-align: top;padding-right:5px;"> {{number_format(($price * $tax) / 100)}} 円</div>
                    @endif
                @endforeach
            </div>
            @endif
