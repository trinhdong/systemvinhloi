                                ...
                                <div class="row justify-content-between card-body position-relative">
                                    @if(isset($data['is_detail']))
                                        <div class="col-12 mb-2 position-absolute" style="top:10px;right:0px;">
                                            <a href="{{route('original-contract-downLoadQuotationPDF',$data['is_detail'])}}" class="btn bg-grey-table float-end border" ><i class="bi bi-file-earmark-arrow-down"></i></a>
                                            <a href="{{route('edit-original-contract',$data['is_detail'])}}" class="btn bg-grey-table float-end me-2 border"><i class="bi bi-pencil-square me-1"></i>編集</a>
                                        </div>
                                    @else                                       
                                    @endif
                                        ...
                                        <div class="fw-bold d-flex font-small font-strong header-table border-bottom border-top py-1" style="background-color:rgb(227 227 227 / 69%);">
                                            ...
                                            @foreach ($data['item_contract'] as $key => $detail)
                                                ...
                                                <div class="col-12 d-flex" >
                                                    <div class="d-flex {{$detail['note'] == null ? 'border-bottom' : ''}} detail_memo align-items-center" data-id='{{$key}}' >
                                                ...
                                                <div class="col-12 d-flex border-bottom-note" >
                                                    <div class="ms-2 d-flex detail_memo align-items-center" data-id='{{$key}}' style="width: 360px;">
                                                        {{$detail['note']}}
                                                    </div>
                                                </div>
                                            @endif
                                            ...
                                            @if($key > 8)
                                                <div class="col-12 d-flex {{$detail['note'] == null ? 'border-bottom' : ''}} ps-0" >
                                                    <div class="d-flex detail_memo align-items-center" data-id='{{$key}}' >
                                                        ...
                                                        <div class="px-1 py-1 text-center sales_discount_rate" style="width:50px">{{number_format($detail['sales_discount_rate'],1)}}</div>
                                                        <div class="px-1 py-1 text-center price" style="width:90px">{{number_format($detail['price'])}}</div>

                                                        <div class="px-1 py-1 text-center consignment" style="width:50px">{{number_format($detail['consignment'])}}</div>
                                                        <div class="px-1 py-1 text-center" style="width:33px"><span class="tax">{{$detail['tax']}}</span>%</div>
                                                        <div class="px-1 py-1 text-center delivery_term" style="width:100px">{{ empty($detail['delivery_term']) ? "" : date('Y/m/d',strtotime($detail['delivery_term'])) }}</div>
                                                        <!-- <div class="d-none product_code">{{$detail['product_code']}}</div> -->
                                                    </div>
                        ...
                        <div class="tab-pane fade" id="purchase" role="tabpanel">
                            <div class="card px-5">
                                <div class="row justify-content-between card-body position-relative">
                                    @if(isset($data['is_detail']))
                                        <div class="col-12 mb-2 position-absolute" style="top:10px;right:0px;">
                                            <a href="{{route('original-contract-downLoadPurchasePDF',$data['is_detail'])}}" class="btn bg-grey-table float-end border" ><i class="bi bi-file-earmark-arrow-down"></i></a>
                                            <a href="{{route('edit-original-contract',$data['is_detail'])}}" class="btn bg-grey-table float-end me-2 border"><i class="bi bi-pencil-square me-1"></i>編集</a>
                                        </div>
                                    @endif
                                    <div class="col-12 text-center mt-2">
                        ...
                        <div class="tab-pane fade" id="order" role="tabpanel">
                            <div class="card px-5">
                                <div class="row justify-content-between card-body position-relative">
                                    @if(isset($data['is_detail']))
                                        <div class="col-12 mb-2 position-absolute" style="top:10px;right:0px;">
                                            <a href="{{route('original-contract-downLoadOrderPDF',$data['is_detail'])}}" class="btn bg-grey-table float-end border" ><i class="bi bi-file-earmark-arrow-down"></i></a>
                                            <a href="{{route('edit-original-contract',$data['is_detail'])}}" class="btn bg-grey-table float-end me-2 border"><i class="bi bi-pencil-square me-1"></i>編集</a>
                                        </div>
                                    @endif
                        ...
                        <div class="tab-pane fade" id="copy" role="tabpanel">
                            <div class="card px-5">
                                <div class="row justify-content-between card-body position-relative">
                                    @if(isset($data['is_detail']))
                                        <div class="col-12 mb-2 position-absolute" style="top:10px;right:0px;">
                                            <a href="{{route('original-contract-downLoadCopyPDF',$data['is_detail'])}}" class="btn bg-grey-table float-end border" ><i class="bi bi-file-earmark-arrow-down"></i></a>
                                            <a href="{{route('edit-original-contract',$data['is_detail'])}}" class="btn bg-grey-table float-end me-2 border"><i class="bi bi-pencil-square me-1"></i>編集</a>
                                        </div>
                                    @endif
                                    <div class="col-12 text-center">
                                    ...
                                    <div class="col-12 p-0 mb-4 paper_memo_2" style="font-size:10px">
                                        ...
                                        @foreach($data['item_contract'] as $key => $detail)
                                            ...
                                            @if($detail['note'])
                                                <div class="col-12 d-flex border-bottom-note" >
                                                    <div class="ms-2 d-flex align-items-center" data-id='{{$key}}' style="width: 360px;">
                                                        {{$detail['note']}}
                                                    </div>
                                                </div>
                                            @endif
