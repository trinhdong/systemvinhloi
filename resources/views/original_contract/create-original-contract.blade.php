...
@section('title')
    {{-- write css this page--}}
    {{__('admin.original_contract_add')}}
@endsection
@section('css')
    {{-- write css this page--}}
    <style>
                    ...
                    <div class="p-3 rounded">
                        <div class="row g-3 form-all">
                            ...
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control order_number" name=""
                                       value="{{Auth::user()->businessLocation->business_code}}-{{date('Y-m-')}}"
                                       readonly>
                            </div>
                            <div class="col-sm-4">
                                <label class="form-label">{{__('admin.contract_order_date')}}</label>
                                <input type="text" class="form-control order_date" name="" value="">
                            </div>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" class="form-control created_date" name="" value="">
                            </div>
                            <div class="col-sm-3">
                                <label class="form-label">{{__('admin.contract_slit_number')}}</label>
                                <input type="text" class="form-control slip_number" name="" value="" min="1">
                            </div>
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control order_code" name="" value="">
                            </div>
                            <div class="col-sm-6">
                                ...
                                <select class="form-select supplier_id" id="supplier_id" name="supplier_id"
                                    ...
                                    @foreach ($list_supplier as $supplier)
                                        <option value="" disabled="disabled" selected></option>
                                        <option
                                            value="{{$supplier->id}}">{{$supplier->supplier_code.' '.$supplier->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <select class="form-control customer_id" id="customer_id" name="customer_id"
                                    ...
                                    @foreach ($list_customer as $customer)
                                        <option value="" disabled="disabled" selected></option>
                                        <option
                                            value="{{$customer->id}}">{{$customer->customer_code.' '.$customer->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-sm-7">
                                <label class="form-label">{{__('admin.contract_delivery_destination')}}</label>
                                <input type="text" class="form-control delivery_destination" name="" value="">
                            </div>
                            <div class="col-sm-5">
                                <label class="form-label">{{__('admin.contract_delivery_phone')}}</label>
                                <input type="text" class="form-control delivery_phone_number" name="" value="">
                            </div>
                            <div class="col-sm-12">
                            ...
                            <div class="mask-total col-sm-12 mt-5">
                                <label for="" class="h5">{{__('admin.contract_detail')}} </label> <span
                                    class="badge bg-secondary">{{__('admin.contract_big_item')}}</span>
                            </div>
                                ...
                                <div class="form-input-original-contract" style="min-width:95%;">
                                    <div class="fw-bold d-flex font-strong border-bottom border-top py-1" style="width:100%;">
                                        <div class="px-1 py-2 text-center"
                                             style="min-width:258px;">{{__('admin.product_code_name')}}</div>
                                        <div class="px-1 py-2 text-center"
                                             style="min-width:76px;width:100%">{{__('admin.product_color')}}</div>
                                        <div class="px-0 py-2 text-center" style="min-width:76px;width: 100%;">取引寸</div>
                                        <div class="px-1 py-2 text-center"
                                             style="min-width:76px;width:100%">{{__('admin.product_inverse')}}</div>
                                        <div class="px-1 py-2 text-center"
                                             style="min-width:76px;width:100%">{{__('admin.product_symbol')}}</div>
                                        <div class="px-1 py-2 text-center"
                                             style="min-width:76px;width:100%">{{__('admin.product_quantity')}}</div>
                                        <div class="px-1 py-2 text-center"
                                             style="min-width:76px;width:100%">{{__('admin.product_unit')}}</div>

                                        <div class="px-1 text-center" style="min-width:200px">
                                            <span>{{__('admin.product_purchage')}}</span>
                                            <div class="d-flex">
                                                <div class="px-1 fw-normal"
                                                     style="min-width:90px;width:100%">{{__('admin.product_hanging_rate')}}</div>
                                                <div class="px-1 fw-normal"
                                                     style="min-width:110px;width:100%">{{__('admin.product_price')}}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="px-1 py-2 text-center"
                                             style="min-width:76px;width:100%">{{__('admin.product_previous_generation')}}</div>
                                        <div class="px-1 py-2 text-center"
                                             style="min-width:76px;width:100%">{{__('admin.product_tax')}}</div>
                                        <div class="px-1 py-2 text-center"
                                             style="min-width:76px;width:100%">{{__('admin.product_deadline')}}</div>
                                    ...
                                    <div class="d-flex border-bottom form-memo" data-id="1">
                                        <div class="px-1 py-2 text-center" style="min-width:258px;;width:100%;">
                                            <div class="input-group">
                                                <input type="text" class="form-control padding-input product_code"
                                                       style="min-width:50px;">
                                                <input type="text" class="form-control padding-input product_name"
                                                       id="product_name_1" style="min-width:200px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="px-1 py-2 text-center trade-size" style="min-width:76px;width: 100%;">
                                            <button style="min-width:100%" class="btn btn-primary border trade-size-modal-btn" type="button" data-id="1">
                                                詳細
                                            </button>
                                        ...
                                        <div class="px-1 py-2 text-center" style="min-width:76px;width:100%;"><input
                                                class="form-control padding-input reciprocal_number" type="number"
                                                min="1"></div>
                                        <div class="px-1 py-2 text-center" style="min-width:76px;width:100%;"><input
                                                class="form-control padding-input standard" type="text"></div>
                                        <div class="px-1 py-2 text-center" style="min-width:76px;width:100%;"><input
                                                class="form-control padding-input quantity" type="number" min="1"></div>
                                        <div class="px-1 py-2 text-center" style="min-width:76px;width:100%;"><input
                                                class="form-control padding-input unit" type="text"></div>

                                        <div class="px-1 py-2 text-center" style="min-width:90px;width:100%;"><input
                                                class="form-control padding-input buy_in_discount_rate" type="number">
                                        </div>
                                        <div class="px-1 py-2 text-center" style="min-width:110px;width:100%;"><input
                                                class="form-control padding-input buy_price" type="number"></div>

                                        <div class="px-1 py-2 text-center" style="min-width:90px;width:100%;"><input
                                                class="form-control padding-input sales_discount_rate" type="number">
                                        </div>
                                        <div class="px-1 py-2 text-center" style="min-width:110px;width:100%;"><input
                                                class="form-control padding-input price" type="number"></div>

                                        <div class="px-1 py-2 text-center" style="min-width:76px;width:100%;"><input
                                                class="form-control padding-input consignment" type="text"></div>
                                        <div class="px-1 py-2 text-center" style="min-width:76px;width:100%;"><input
                                                class="form-control padding-input tax" type="number" min></div>
                                        <div class="px-1 py-2 text-center" style="min-width:110px"><input
                                                class="form-control padding-input delivery_term_1" type="text"></div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control created_person">
                            </div>
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12 text-center">
                                <button onclick="history.back()"
                                        class="btn btn-secondary">{{__('admin.btn_back')}}</button>
                                <button type="button" class="btn btn-primary save-memo-all"
                                        id="submitButton">{{__('admin.btn_create')}}</button>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="tab-pane fade active show" id="quotation" role="tabpanel">
                                <div class="row">
                                    ...
                                    <div class="col-7">
                                        <div class="row">
                                            <div
                                                class="col-2 p-1 border border-end-0">{{__('admin.contract_order_date')}}</div>
                                            <div class="col-4 p-1 border border-end-0"><span
                                                    class="order_date_paper"></span></div>
                                            <div
                                                class="col-3 p-1 border border-end-0">{{__('admin.contract_place_of_import')}}</div>
                                            <div class="col-3 p-1 border place_of_import_paper"></div>

                                            <div
                                                class="col-4 p-1 border border-top-0 border-end-0">{{__('admin.contract_supplier_id')}}</div>
                                            <div class="col-8 p-1 border border-top-0 supplier_id_paper"></div>
                                            <div
                                                class="col-4 p-1 border border-top-0 border-end-0">{{__('admin.contract_customer_id')}}</div>
                                            <div class="col-8 p-1 border border-top-0 customer_id_paper"></div>
                                            <div
                                                class="col-4 p-1 border border-top-0 border-end-0">{{__('admin.contract_delivery_destination')}}</div>
                                            <div class="col-8 p-1 border border-top-0 delivery_destination_paper"></div>
                                            <div
                                                class="col-4 p-1 border border-top-0 border-end-0">{{__('admin.contract_delivery_address')}}</div>
                                            <div class="col-8 p-1 border border-top-0 delivery_address_paper"></div>
                                            <div
                                                class="col-4 p-1 border border-top-0 border-end-0">{{__('admin.contract_delivery_phone')}}</div>
                                            <div
                                                class="col-8 p-1 border border-top-0 delivery_phone_number_paper"></div>
                                        </div>
                                    </div>
                                    <div class="col-5">
                                        <div class="row">
                                            <div class="col-5">{{__('admin.contract_created_date')}}</div>
                                            <div class="col-7 text-end created_date_paper"></div>

                                            <div class="col-5">{{__('admin.contract_slit_number')}}</div>
                                            <div class="col-7 text-end slip_number_paper"></div>

                                            <div class="col-5">{{__('admin.contract_person_in_charge')}}</div>
                                            <div class="col-7 text-end person_in_charge_paper"></div>

                                            <div class="col-5">{{__('admin.contract_order_code')}}</div>
                                            <div class="col-7 text-end order_code_paper"></div>
                                    ...
                                    <div class="mask-total col-12 mt-3 ">
                                        <label class="h5"> <span
                                                class="fw-bold">{{__('admin.preview_estimated_amount')}}</span> <span
                                                class="total_tax"></span><span class="fw-bold">円</span></label>
                                        <span>（{{__('admin.preview_internal_consumption_tax')}}<span
                                                class="tax"></span>円）</span>
                                    </div>
                                    <div class="col-12 p-0 mb-4 paper_memo" style="font-size:10px">
                                        <div
                                            ...
                                            <div class="px-1 py-2 text-center"
                                                 style="width:180px;">{{__('admin.product_code_name')}}</div>
                                            <div class="px-1 py-2 text-center"
                                                 style="width:33px">{{__('admin.product_color')}}</div>
                                            <div class="px-1 py-2 text-center"
                                                 style="width:33px">{{__('admin.product_inverse')}}</div>
                                            <div class="px-1 py-2 text-center"
                                                 style="width:33px">{{__('admin.product_symbol')}}</div>
                                            <div class="px-1 py-2 text-center"
                                                 style="width:33px">{{__('admin.product_quantity')}}</div>
                                            <div class="px-1 py-2 text-center"
                                                 style="width:33px">{{__('admin.product_unit')}}</div>

                                            <div class="px-1 text-center" style="width:140px">
                                                <span>{{__('admin.product_earnings')}}</span>
                                                <div class="d-flex">
                                                    <div class="px-1 fw-normal"
                                                         style="width:75px">{{__('admin.product_hanging_rate')}}</div>
                                                    <div class="px-1 fw-normal"
                                                         style="width:80px">{{__('admin.product_price')}}</div>
                                                </div>
                                            </div>

                                            <div class="px-1 py-2 text-center"
                                                 style="width:33px">{{__('admin.product_previous_generation')}}</div>
                                            <div class="px-1 py-2 text-center"
                                                 style="width:33px">{{__('admin.product_tax')}}</div>
                                            <div class="px-1 py-2 text-center"
                                                 style="width:100px">{{__('admin.product_deadline')}}</div>
                                        </div>
                                        <div class="d-flex border-bottom detail_memo_empty">
                                            <div class="px-1 py-2 text-center"
                                                 style="width:651px">{{__('message.data_not_found')}}</div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="row mb-2">
                                            <div class="col-5">{{__('admin.product_serial_number')}}</div>
                                            <div class="col-7 text-end serial_number_paper"></div>

                                            <div class="col-5">{{__('admin.product_creditor')}}</div>
                                            <div class="col-7 text-end created_person_paper"></div>
                                            ...
                                            <div class="tax_percent col-12">
                                                <div class="row">
                                                    <div class="col-6 text-grey">{{__('admin.preview_items')}} <span
                                                            class="percent_tax"></span>{{__('admin.preview_percent_tax')}}
                                                    </div>
                                                    <div class="col-6 text-end text-grey"><span class="total"></span>  円
                                                    </div>
                                                    <div class="col-6"></div>
                                                    <div class="col-6 text-end text-grey"><span class="tax"></span>　円
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-7">
                                        <div class="row">
                                            ...
                                            <div
                                                class="col-3 p-1 border border-end-0">{{__('admin.contract_place_of_import')}}</div>
                                            <div class="col-3 p-1 border"><span class="place_of_import_paper"></span>
                                            </div>

                                            <div
                                                class="col-4 p-1 border border-top-0 border-end-0">{{__('admin.contract_supplier_id')}}</div>
                                            <div class="col-8 p-1 border border-top-0"><span
                                                    class="supplier_id_paper"></span></div>
                                            <div
                                                class="col-4 p-1 border border-top-0 border-end-0">{{__('admin.contract_customer_id')}}</div>
                                            <div class="col-8 p-1 border border-top-0"><span
                                                    class="customer_id_paper"></span></div>
                                            <div
                                                class="col-4 p-1 border border-top-0 border-end-0">{{__('admin.contract_delivery_destination')}}</div>
                                            <div class="col-8 p-1 border border-top-0"><span
                                                    class="delivery_destination_paper"></span></div>
                                            <div
                                                class="col-4 p-1 border border-top-0 border-end-0">{{__('admin.contract_delivery_address')}}</div>
                                            <div class="col-8 p-1 border border-top-0"><span
                                                    class="delivery_address_paper"></span></div>
                                            <div
                                                class="col-4 p-1 border border-top-0 border-end-0">{{__('admin.contract_delivery_phone')}}</div>
                                            <div class="col-8 p-1 border border-top-0"><span
                                                    class="delivery_phone_number_paper"></span></div>
                                        </div>
                                    </div>
                                    <div class="col-5">
                                        <div class="row">
                                    ...
                                    <div class="col-12 p-0 mb-4 paper_memo_2" style="font-size:10px">
                                        <div
                                            ...
                                            style="background-color:rgb(227 227 227 / 69%);">
                                            <div class="px-1 py-2 text-center text-wrap"
                                                 style="width:120px;">{{__('admin.product_code_name')}}</div>
                                            <div class="px-1 py-2 text-center"
                                                 style="width:29px">{{__('admin.product_color')}}</div>
                                            <div class="px-1 py-2 text-center"
                                                 style="width:29px">{{__('admin.product_inverse')}}</div>
                                            <div class="px-1 py-2 text-center"
                                                 style="width:29px">{{__('admin.product_symbol')}}</div>
                                            <div class="px-1 py-2 text-center"
                                                 style="width:29px">{{__('admin.product_quantity')}}</div>
                                            <div class="px-1 py-2 text-center"
                                                 style="width:29px">{{__('admin.product_unit')}}</div>

                                            <div class="px-1 text-center" style="width:58px">
                                                <span>{{__('admin.product_purchage')}}</span>
                                                <div class="d-flex">
                                                    <div class="px-1 fw-normal"
                                                         style="width:29px">{{__('admin.product_hanging_rate')}}</div>
                                                    <div class="px-1 fw-normal"
                                                         style="width:29px">{{__('admin.product_price')}}</div>
                                                </div>
                                            </div>

                                            <div class="px-1 text-center" style="width:100px">
                                                <span>{{__('admin.product_earnings')}}</span>
                                                <div class="d-flex">
                                                    <div class="px-1 fw-normal"
                                                         style="width:30px">{{__('admin.product_hanging_rate')}}</div>
                                                    <div class="px-1 fw-normal"
                                                         style="width:70px">{{__('admin.product_price')}}</div>
                                                </div>
                                            </div>

                                            <div class="px-1 py-2 text-center"
                                                 style="width:29px">{{__('admin.product_previous_generation')}}</div>
                                            <div class="px-1 py-2 text-center"
                                                 style="width:33px">{{__('admin.product_tax')}}</div>
                                            <div class="px-1 py-2 text-center"
                                                 style="width:90px">{{__('admin.product_deadline')}}</div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 p-0 mb-4 paper_memo_2" style="font-size:10px">
                                        <div
                                            ...
                                            <div class="px-1 text-center" style="width:70px">
                                                <span>{{__('admin.product_purchage')}}</span>
                                                <div class="d-flex">
                                                    <div class="px-1 fw-normal"
                                                         style="width:20px">{{__('admin.product_hanging_rate')}}</div>
                                                    <div class="px-1 fw-normal"
                                                         style="width:50px">{{__('admin.product_price')}}</div>
                                                </div>
                                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-toggle="modal"
                            data-bs-target="#descriptionModal">{{__('admin.btn_back')}}</button>
...
@endsection
@section('script')
    <script src="js/memo-original-contract.js"></script>
    <script>
        $(document).ready(function () {
            ...
            $('.save-memo-all').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('create-original-contract-post') }}",
                    data: {
                        _token: "{{ csrf_token() }}",
                        data: data,
            ...
            $('.btn-preview').click(function(){
                ...
                var win = window.open('/original_contract/preview', '_blank');
                if (win) {
                    win.focus();
                } else {
            ...
            async function savePreviewAjax(data){
                await $.ajax({
                    type: "POST",
                    url: "{{ route('original-contract-savePreview') }}",
                    data: {
                        _token: "{{ csrf_token() }}",
                        data : data,
                    },
