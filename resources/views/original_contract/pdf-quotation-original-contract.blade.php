...
<div class="container" >
    ...
    <div style="background-color:lightgrey;font-size:10px;padding-top:13px;">
        <div style="display:inline-block;width:250px;margin-left:5px;" >{{__('admin.product_name')}}</div>
    ...
    @foreach ($data->originalContractDetail as $detail)
        <div style="font-size:8px;margin-bot:0px;margin-top:2px;{{ $detail->note == null ? 'border-bottom:1px solid lightgrey;' : 'border-left: 0px;border-right: 0px;border-bottom: 1px dashed lightgray;border-style: 1px solid dashed;'}}padding: 5px 5px;background-color:rgb(255, 255, 255)">
            <div style="display:inline-block;width:250px;vertical-align: middle;margin-left:5px;" >
                <!-- <div style="color:rgb(105, 105, 105);font-size:12px;width:180px;word-wrap: break-word;">{{ $detail->product_code }}</div> -->
                <div style="width:250px;word-wrap: break-word;">{{ $detail->product_name }}</div>
                {{-- <div style="color:rgb(105, 105, 105);width:250px;word-wrap: break-word;">{{ $detail->note }}</div> --}}
            </div>
